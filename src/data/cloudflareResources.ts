...
const LESSON_KEYWORDS: Record<string, string[]> = {
  ...
  'as-0-l1': ['how cloudflare works', 'proxy', 'add a site'],
  'as-5-l1': ['api shield', 'mtls', 'api security'],
  'as-6-l1': ['load balancing', 'waiting room', 'ddos'],
  'as-7-l1': ['waf', 'ssl/tls', 'cache', 'best practice'],
  'as-7-l2': ['add a site', 'managed rules', 'cache rule'],
  'dp-0-l1': ['workers', 'c3', 'wrangler', 'get started'],
  'dp-1-l1': ['workers', 'c3', 'wrangler', 'hello world', 'get started'],
  'dp-1-l2': ['wrangler', 'secret', 'compatibility_date'],
  'dp-2-l1': ['pages', 'git integration', 'deploy', 'migrate from netlify', 'migrate from vercel'],
  'dp-2-l2': ['pages functions', 'api route', 'front end using pages functions'],
  'dp-6-l1': ['durable objects', 'queues', 'workflows', 'hyperdrive'],
  'dp-7-l1': ['workers', 'best practice', 'secret'],
  'dp-7-l2': ['wrangler', 'c3', 'd1', 'r2'],
